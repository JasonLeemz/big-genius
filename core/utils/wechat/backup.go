...
//	if err != nil {
//		log.Logger.Errorf("base64 decrypt err:%v", err)
...
//	_, rawXMLMessage, corpid, err := AESDecryptMsg(ciphertext, []byte(encodingAESKey))
//	if err != nil {
//		log.Logger.Errorf("aes decrypt err:%v", err)
//		return "", DecryptAESError
//	}
//	corpID := config.GlobalConfig.WeChat.CorpID
